              ...
              <div class="flex items-center gap-3">
                ...
                <dd class="text-fg-muted">
                  @for (lang of profile().languages; track lang.name; let last = $last) {
                    {{ lang.name }} ({{ lang.level }})@if (!last) {<span>, </span>}
                  }
                </dd>
              </div>
            </dl>
          ...
          <div class="lg:col-span-7">
            ...
            >
              <p class="font-mono text-sm leading-relaxed text-fg-muted">
                ...
                <span class="block pl-4 text-fg">selector: <span class="text-emerald-300">'app-tawfik'</span>,</span>
                <span class="block pl-4 text-fg">mission: <span class="text-emerald-300">'Ship interfaces that feel inevitable'</span>,</span>
                <span class="block pl-4 text-fg">stack: <span class="text-emerald-300">'Angular · TypeScript · Tailwind'</span>,</span>
                &#125;)
              </p>
            </div>
          </div>
