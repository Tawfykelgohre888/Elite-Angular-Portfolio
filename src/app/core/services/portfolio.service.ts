...
export class PortfolioService {
  ...
  private readonly _skills = signal<readonly Skill[]>([
    ...
    { name: 'JavaScript (ES6+)', category: 'frontend', level: 88, accent: 'violet' },
    ...
    { name: 'Angular Material', category: 'styling', level: 80, accent: 'pink' },
    { name: 'PrimeNG', category: 'styling', level: 78, accent: 'pink' },
    { name: 'Responsive Design', category: 'styling', level: 92, accent: 'pink' },
    ...
    { name: 'Component Architecture', category: 'practice', level: 90, accent: 'cyan' },
  ...
  readonly stats = computed(() => ({
    ...
    yearsExperience: 2,
    coursesCompleted: this._experience().filter((e) => e.type === 'course').length,
  }));
  ...
  readonly educationOnly = computed(() =>
    this._experience().filter((e) => e.type === 'education' || e.type === 'course'),
  );
}
